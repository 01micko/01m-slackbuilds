...
## additions
If you have any wayland specific slackbuilds you want to share then
you are most welcome to open a pull request. Also accepting slackbuild
scripts for programs that run in wayland natively.
